...
Testing PPA:
[ppa:xubuntu-dev/xfce4-gtk3](https://launchpad.net/~xubuntu-dev/+archive/ubuntu/xfce4-gtk3/+packages)

Xfce 4.14 [roadmap](https://wiki.xfce.org/releng/4.14/roadmap)
...
-   [tumbler](http://git.xfce.org/users/ali/tumbler/)
    1.  gdbus port.
-   [xfconf](http://git.xfce.org/users/ali/xfconf/log/?h=gdbus-port)
    1.  gdbus port.
    2.  Currently in an unusable state.
-   xfce4-appfinder
-   xfce4-taskmanager
