...
**Please note:** Xubuntu 24.10 is an interim release featuring
pre-release software, Xfce 4.19. You may encounter more bugs than usual.
If you need a stable, well-supported, environment, please consider
installing [Xubuntu 24.04 LTS, \"Noble
Numbat\"](https://wiki.xubuntu.org/releases/24.04/release-notes)
instead.
