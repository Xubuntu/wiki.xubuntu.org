...
information - there are more details on the [Reporting Back](../report) page, but for now please be
...
-   If however, the Install Alongside isn't available you need to
    ...
    installing. We have a section on the [fine tuning page](../fine_tuning) that works through
    this issue.
