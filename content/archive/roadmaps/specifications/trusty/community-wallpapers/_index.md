...
### Assumptions
  ...
  - The Xubuntu desktop session and elementary-xfce icon themes may be used.
...
It is important to note Ubuntu – and hence Xubuntu – is shipped to users from every part of the globe. Your images should be considerate of this diversity and refrain from the following.
  ...
  - No branding assets like “Xubuntu logo” or text to permit use by derivative distributions.
...
### Composition
  ...
  - Design must accommodate Xubuntu's panels.
...
It is important to note the diversity of displays which Xubuntu needs to support. Although the desired image format is 2560 x 1600 pixels the composition should support a variety of image formats.
...
To submit your wallpapers for potential use in Xubuntu 14.04, please post them on this [submissions-page](submissions/). Thanks in advance!
