...
- gnome-system-tools
  - [GstToUmbrella](https://wiki.ubuntu.com/GstToUmbrella)
  - nautilus plugin
...
- Completely agree with this idea, have been thinking the same since I started using Xubuntu. Two application you have missed are gnome system monitor (can easily be replaced with Xfce Task Manager) and notification daemon (can easily be replaced with xfce-notifyd). I have other suggestions of replacements [here.](https://wiki.ubuntu.com/Slim%20down%20Xubuntu%20sessions) 
