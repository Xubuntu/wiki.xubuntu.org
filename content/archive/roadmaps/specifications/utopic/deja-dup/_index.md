---
title: "Specifications — Utopic — Deja-Dup"
---
...
| Overview | |
|---|---|
| **Title** | A default backup solution for Xubuntu |
| **Blueprint** | - |
| **Assignee** | - |
...
#### Long answer
Many of you know that Ubuntu, from some years, adopts Deja-Dup as default backup system. Basically Deja-Dup is a GUI frontend to make very easy to backup / restore files and folders using the powerful "[duplicity](http://duplicity.nongnu.org/)" tool.
