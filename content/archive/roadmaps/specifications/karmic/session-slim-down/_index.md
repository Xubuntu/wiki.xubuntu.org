...
See [LP #323322](https://bugs.edge.launchpad.net/ubuntu/+source/system-config-printer/+bug/323322) for further details.
...
- "I've noticed that just by removing the xubuntu customizations, themes, artwork and leaving it to the xfce default setup and look, the memory usage in my system came down a lot and is much faster." - [mathiraj](https://blueprints.launchpad.net/xubuntu-desktop/+spec/xubuntu-karmic-session-slim-down)
- "The package xubuntu-default-settings, which pulls in usplash and artwork, etc, increased memory usage by around 15MB." - [DistroWatch Weekly, Issue 301, 4 May 2009](http://distrowatch.com/weekly.php?issue=20090504#feature)
