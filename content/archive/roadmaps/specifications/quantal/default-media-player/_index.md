...
*Migrated from [Ubuntu Wiki](https://wiki.ubuntu.com/Xubuntu/Roadmap/Specifications/Quantal/DefaultMediaPlayer), last updated 2012-11-11.*
...
|---|---|---|---|---|---|---|---|---|---|---|
| Software | Music Library | Playlist separated from music library | search only music library | Search only playlist | Save playlists to file | Streams reproduction | installed size | in the repos | toolkit | note |
| **gmusicbrowser** | (./) | (./) | (./) | (./) | {X} | (./) | 2962 kB | yes | gtk | has multiple skins |
| **exaile** | (./) | (./) | (./) | (./) | {X} | (./) | 4681 kB | yes | gtk | |
| **Rhythmbox** | (./) | (./) | (./) | (./) | (./) | (./) | 866 kB | yes | gtk | |
| **guayadeque** | (./) | (./) | (./) | (./) | (./) | (./) | 5692 kB | yes | gtk | Randomly adds songs to the queue, unknown reason |
| **Audacious** | (./) | (./) | (./) | (./) | (./) | (./) | 1424 kB | yes | gtk | |
| **Quodlibet** | (./) | (./) | (./) | (./) | (./) * | (./) | 92 kB | yes | gtk | *it can save playlists adding an extension, but it wont load them. |
| **Listen** | (./) | (./) | (./) | (./) | (./) | (./) | 2824 kB | yes | gtk | |
| **musique** | (./) | (./) | {X} | {X} | {X} | (./) | 1265 kB | yes | gtk | |
| **decibel-audio-player** | (./) * | (./) | {X} | {X} | (./) | {X} | 1776 kB | yes | gtk | |
