...
*Migrated from [Ubuntu Wiki](https://wiki.ubuntu.com/Xubuntu/TeamReports/09/January), last updated 2009-02-15.*
...
- New pages for reporting bugs to Xfce-Bugzilla, AbiWord, and Listen were added to "[Bugs/Upstream](https://wiki.ubuntu.com/Bugs/Upstream)".

#### Community

- Following the [Grow the Xubuntu Community](https://wiki.ubuntu.com/Xubuntu/Roadmap/Specifications/Jaunty/GrowXubuntuCommunity) -specification.
