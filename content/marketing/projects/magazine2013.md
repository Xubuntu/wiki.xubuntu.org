...
-   [Contributing to Xubuntu: testing the Xubuntu daily
    ...
    Doak* (2p)
-   [Managing Themes and Styles](http://pad.ubuntu.com/xubuntu-articles-themes) (include
    installing locally and globally) - *baizon* and *Richard Dennis*
    (3p)
-   [Navigating the Xfce Desktop](http://pad.ubuntu.com/xubuntu-articles-xfce) - *Shawn
    Nguyen* (3p)
-   [Experiences, challenges and the reasons I settled on
    Xubuntu](http://pad.ubuntu.com/xubuntu-articles-settledonxubuntu) -
    *Inoki Sakaeru* (4p)
-   [(Getting involved with) the Xubuntu
    community](http://pad.ubuntu.com/xubuntu-articles-xubuntucommunity) -
    *Pasi Lallinaho* (2p)
-   [Controlling your Xubuntu Desktop](http://pad.ubuntu.com/xubuntu-articles-controlling)
